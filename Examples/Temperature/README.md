...
# Source Code
**Notes for all** 
- this example requires at least one temperature probe to be attached to one of the 2 sets of screw terminals.
- there is a dependency of the DS2482 library by Joe Young and our DSTemp library.
