/***********************************************************************//**
  ...
  This simple example sends DS18B20 temperatures for main cabin and water temperature information
  to the NMEA2000 bus. 
...
double ReadCabinTemp() {
  return CToKelvin(dsTemp.ftemps[0]); // use the 1st temperature as cabin temp
}

// *****************************************************************************
double ReadWaterTemp() {
  return CToKelvin(dsTemp.ftemps[1]); // use the 2nd temperature as water temp
}
